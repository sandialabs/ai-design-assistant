import pathlib
ada_path = pathlib.Path(__file__).parent
...
# path_to_corsair = pathHere[0:-21] # removes the trailing '/corsair/__init__.py' giving the package location
# if path_to_corsair[-1] != 'r':
#     path_to_corsair = pathHere[0:-20] #need to account for running off of .py and not .pyc the first time
...
# from corsair.core.locationChecks import inNotebook
# from corsair.core.locationChecksimport inIPython
# def help(helpItem):
# 	if inIPython():
