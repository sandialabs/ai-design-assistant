...
# Below is a python script that uses XFOIL to analyze a NACA 2412 airfoil at 4 degrees angle of 
...
# panels are used to define the airfoil geometry.  Pressure coefficient data is dumped to a file 
# named 'cp_data.txt' and boundary layer data is dumped to a file named 'bl_data.txt'.  Coefficients 
# of lift, drag, and moment are dumped to a file named 'polars.txt'.  
...
# - "Generate a python script for running xfoil"
# - "Create a python script for running a NACA 2412 airfoil using xfoil"
# - "Produce a python script for running a NACA 2412 airfoil at 4 degrees angle of attack using xfoil"
# - "Give me a python script that calls xfoil"
...
airfoil         = "naca2412"  # uses same names as located in the airfoil folders
